...
// `start` and `end` are logical sides — they swap based on the document
// direction. In LTR `start = left`, in RTL `start = right`. The slide
// animations need physical translation, so the `rtl:` variant flips them.
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 text-center sm:text-end',
      className
    )}
    {...props}
  />
